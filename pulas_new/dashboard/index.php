        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">
<?php 
  $query = mysql_query("select * from puskes where kategori = 'Rumah Sakit'");$data = array();  while(($row = mysql_fetch_array($query)) != null){$data[] = $row;}$count = count($data);  echo $count.' Data';
?>
                    </p>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">
<?php 
  $query = mysql_query("select * from puskes where kategori = 'Puskesmas'");$data = array();  while(($row = mysql_fetch_array($query)) != null){$data[] = $row;}$count = count($data);  echo $count.' Data';
?>
                    </p>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">
<?php 
  $query = mysql_query("select * from puskes where kategori = 'Klinik'");$data = array();while(($row = mysql_fetch_array($query)) != null){$data[] = $row;}$count = count($data);echo $count.' Data';
?>
                    </p>
                    <p class="text-muted">Klinik</p>
                </div>
             </div>
		     </div>
			</div>
...
<?php
  $query = mysql_query("select * from puskes");while ($data = mysql_fetch_array($query)){$kategori=$data['kategori'];$nama=$data['nama'];$lat=$data['lat'];$lon=$data['lng'];if($kategori=='Rumah Sakit'){echo ("addMarker1($lat, $lon, '<b>$kategori $nama</b>');\n");}elseif($kategori=='Puskesmas'){echo ("addMarker2($lat, $lon, '<b>$kategori $nama</b>');\n");}else{echo ("addMarker3($lat, $lon, '<b>$kategori $nama</b>');\n");}}
?>
